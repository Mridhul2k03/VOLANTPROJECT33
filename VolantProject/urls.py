...
urlpatterns = [
    ...
    path('orderdelete/<int:id>',views.RemoveOrderItem.as_view(),name='orderdelete'),
    path('adminmessages',views.UserMessagesforAdmin.as_view(),name='adminmessages'),
    path('adminallmessages',views.MessagesforAdmin.as_view(),name='adminallmessages'),
    path('search/',views.UserSearchResults.as_view(),name='search'),
    path('anonymoussearch/',views.NonUserSearchResults.as_view(),name='nonsearch'),
