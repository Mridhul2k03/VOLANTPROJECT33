...
from .models import CartModel, Footwearimages,Footwears,Footwearsize,OrderModel,ContactModel, UserContactModel
...
class ContactForm(forms.ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            'name':forms.TextInput(attrs={'class':'form-control w-100','placeholder':'Enter your name'}),
            'email':forms.EmailInput(attrs={'class':'form-control w-100','placeholder':'enter email'}),
            'phone':forms.TextInput(attrs={'class':'form-control w-100','placeholder':'Enter subject','maxlength':10,'minlength':10}),
            'message':forms.Textarea(attrs={'class':'form-control w-100','placeholder':'Enter message'}),
        }
